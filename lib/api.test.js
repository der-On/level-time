...
describe('api', function () {
  ...
  it('should consolidate all timers', function () {
    var db = createDb();
    var api = Api({ db: db });
    var num = 0;
    var promises = [];
  ...
  it('should remove a group and all of its timers', function () {
    var db = createDb();
    var api = Api({ db: db });
    var num = 0;
    var promises = [];
